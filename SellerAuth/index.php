...
$data = $conn->query("SELECT id FROM sellers_details WHERE email = '$email' AND password = '$password'");

if ($data -> num_rows > 0) {
  # User Aviliable if yes start the session and redirect the farmer to their homepage

  $_SESSION['sellerLoggedIn']=1;
  $_SESSION['username']=$email;
  header('Location:../HomePages/sellerPage.php');
  ...
  <html>
    ...
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        <li><a href="RegSeller.php">SignUp</a></li>
  ...
  <ul class="sidenav" id="mobile-demo">
    <li><a href="RegSeller.php">SignUp</a></li>
      ...
      <div class="container">
       ...
       <br><br><br>
       <div class="row">
        <h4 class="center"> Supplier Login</h4>
    <form class="col s12 center" action="" method="POST">
      ...
      <div class="row">
        <div class="col s12">
         <center><input type="submit" name="logSell" class="btn btn-large orange white-text" value="Login"></center>
