...
// Close connection
$status = "In Progress";
      $sql = "INSERT INTO cropd_details (cropd_id,farmer_id,farmer_name,crop_name,req_qty,amount,status,sup_email,buyer_email) VALUES ('$crp_id','$farmerid','$farmername','$crp_name','$crp_qty','$crp_amount','$status','$sup_email','$buyer_email')";
if(mysqli_query($connection, $sql)){
    ...
    ?>
      ...
      <div class="row">
        <div class="input-field col s6">
          ...
          <label for="crp_qty">Required Quantity(in KG)</label>
        </div>
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="sup_email" type="text" class="validate" value="<?php echo $semail; ?>" readonly name="sup_email">
          <label for="sup_email">Supplier Email</label>
        </div>
        <div class="input-field col s6">
          <input id="buyer_email" type="text" class="validate" value="<?php echo $buyer_email; ?>" readonly name="buyer_email">
          <label for="buyer_email">Farmer Email</label>
        </div>
      </div>
      <div class="row">
         <div class="input-field col s6">
